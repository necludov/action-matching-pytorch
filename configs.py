...
job_configs.am_cifar_diffusion = make_am_cifar_diffusion()
job_configs.am_cifar_torus = make_am_cifar_torus()
job_configs.am_cifar_color = make_am_cifar_color()
job_configs.am_cifar_superres = make_am_cifar_superres()
